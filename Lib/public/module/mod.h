...
/* Module registration */
int m_mod_register(const char *name, m_ctx_t *c, m_mod_t **mod, const m_userhook_t *hook,
...
/* Module state getter */
bool m_mod_is(const m_mod_t *mod, const m_mod_states st);
...
int m_mod_src_register_sgn(m_mod_t *mod, const m_src_sgn_t *its, const m_src_flags flags, const void *userptr);
int m_mod_src_deregister_sgn(m_mod_t *mod, const m_src_sgn_t *its);

int m_mod_src_register_path(m_mod_t *mod, const m_src_path_t *its, const m_src_flags flags, const void *userptr);
