...
void test_module_register_NULL_name(void **state) {
    ...
    int ret = module_register(NULL, CTX, &self, &hook, 0);
    assert_false(ret == 0);
    assert_null(self);
}
...
void test_module_register_NULL_ctx(void **state) {
    ...
    userhook_t hook = (userhook_t) { init, evaluate, recv, destroy };
    int ret = module_register("testName", NULL, &self, &hook, 0);
    assert_false(ret == 0);
    assert_null(self);
}
...
void test_module_register_NULL_self(void **state) {
    ...
    userhook_t hook = (userhook_t) { init, evaluate, recv, destroy };
    int ret = module_register("testName", CTX, NULL, &hook, 0);
    assert_false(ret == 0);
    assert_null(self);
}
...
void test_module_register_NULL_hook(void **state) {
    ...
    int ret = module_register("testName", CTX, &self, NULL, 0);    
    assert_false(ret == 0);
    assert_null(self);
}
...
void test_module_register(void **state) {
    ...
    userhook_t hook = (userhook_t) { init, evaluate, recv, destroy };
    int ret = module_register("testName", CTX, &self, &hook, 0);
    assert_true(ret == 0);
...
void test_module_register_same_name(void **state) {
    ...
    userhook_t hook = (userhook_t) { init, evaluate, recv, destroy };
    int ret = module_register("testName", CTX, &self2, &hook, 0);
    assert_false(ret == 0);
    assert_null(self2);
}
...
void test_module_deregister_NULL_self(void **state) {
    ...
    int ret = module_deregister(NULL);
    assert_false(ret == 0);
    assert_non_null(self);
}
...
void test_module_deregister(void **state) {
    ...
    int ret = module_deregister(&self);
    assert_true(ret == 0);
    assert_null(self);
}
...
void test_module_set_userdata_NULL_self(void **state) {
    ...
    int ret = module_set_userdata(NULL, NULL);
    assert_false(ret == 0);
}
...
void test_module_set_userdata(void **state) {
    ...
    int ret = module_set_userdata(self, NULL);
    assert_true(ret == 0);
}
...
void test_module_become_NULL_self(void **state) {
    ...
    int ret = module_become(NULL, NULL);
    assert_false(ret == 0);
}
...
void test_module_become_NULL_func(void **state) {
    ...
    int ret = module_become(self, NULL);
    assert_false(ret == 0);
}
...
void test_module_become(void **state) {
    ...
    int ret = module_become(self, recv);
    assert_true(ret == 0);
}
...
void test_module_add_wrong_fd(void **state) {
    ...
    int ret = module_register_fd(self, -1, SRC_FD_AUTOCLOSE, NULL);
    assert_false(ret == 0);
}
...
void test_module_add_fd_NULL_self(void **state) {
    ...
    int ret = module_register_fd(NULL, STDIN_FILENO, SRC_FD_AUTOCLOSE, NULL);
    assert_false(ret == 0);
}
...
void test_module_add_fd(void **state) {
    ...
    int ret = module_register_fd(self, STDIN_FILENO, SRC_FD_AUTOCLOSE, NULL);
    assert_true(ret == 0);
}
...
void test_module_rm_wrong_fd(void **state) {
    ...
    int ret = module_deregister_fd(self, -1);
    assert_false(ret == 0);
}
...
void test_module_rm_wrong_fd_2(void **state) {
    ...
    int ret = module_deregister_fd(self, STDIN_FILENO + 1);
    assert_false(ret == 0);
}
...
void test_module_rm_fd_NULL_self(void **state) {
    ...
    int ret = module_deregister_fd(NULL, STDIN_FILENO);
    assert_false(ret == 0);
}
...
void test_module_rm_fd(void **state) {
    ...
    int ret = module_deregister_fd(self, STDIN_FILENO);
    assert_true(ret == 0);
...
void test_module_subscribe_NULL_topic(void **state) {
    ...
    int ret = module_register_sub(self, NULL, 0, NULL);
    assert_false(ret == 0);
}
...
void test_module_subscribe_NULL_self(void **state) {
    ...
    int ret = module_register_src(NULL, "topic", 0, NULL);
    assert_false(ret == 0);
}
...
void test_module_subscribe(void **state) {
    ...
    int ret = module_register_src(self, "topic", 0, NULL);
    assert_true(ret == 0);
}
...
void test_module_ref_NULL_name(void **state) {
    ...
    int ret = module_ref(self, NULL, &testSelf);
    assert_false(ret == 0);
}
...
void test_module_ref_unexhistent_name(void **state) {
    ...
    int ret = module_ref(self, "testName2", &testSelf);
    assert_false(ret == 0);
}
...
void test_module_ref_NULL_ref(void **state) {
    ...
    int ret = module_ref(self, "testName2", NULL);
    assert_false(ret == 0);
}
...
void test_module_ref(void **state) {
    ...
    int ret = module_ref(self, "testName", &testSelf);
    assert_true(ret == 0);
}
...
void test_module_tell_NULL_recipient(void **state) {
    ...
    int ret = module_tell(self, NULL, (unsigned char *)"hi!", strlen("hi!"), 0);
    assert_false(ret == 0);
}
...
void test_module_tell_NULL_self(void **state) {
    ...
    int ret = module_tell(NULL, testSelf, (unsigned char *)"hi!", strlen("hi!"), 0);
    assert_false(ret == 0);
}
...
void test_module_tell_NULL_msg(void **state) {
    ...
    int ret = module_tell(self, testSelf, NULL, 10, 0);
    assert_false(ret == 0);
}
...
void test_module_tell_wrong_size(void **state) {
    ...
    int ret = module_tell(self, testSelf, (unsigned char *)"hi!", -1, 0);
    assert_false(ret == 0);
}
...
void test_module_tell(void **state) {
    ...
    int ret = module_tell(self, testSelf, (unsigned char *)"hi1!", strlen("hi!"), PS_DUP_DATA);
    assert_true(ret == 0);
}
...
void test_module_publish_NULL_self(void **state) {
    ...
    int ret = module_publish(NULL, "topic", (unsigned char *)"hi!", strlen("hi!"), 0);
    assert_false(ret == 0);
}
...
void test_module_publish_NULL_msg(void **state) {
    ...
    int ret = module_publish(self, "topic", NULL, 10, 0);
    assert_false(ret == 0);
}
...
void test_module_publish_NULL_topic(void **state) {
    ...
    int ret = module_publish(self, NULL, (unsigned char *)"hi!", strlen("hi!"), 0);
    assert_false(ret == 0);
}
...
void test_module_publish_wrong_size(void **state) {
    ...
    int ret = module_publish(self, "topic", (unsigned char *)"hi!", -1, 0);
    assert_false(ret == 0);
}
...
void test_module_publish(void **state) {
    ...
    int ret = module_publish(self, "topic", (unsigned char *)"hi2!", strlen("hi!"), 0);
    assert_true(ret == 0);
}
...
void test_module_broadcast_NULL_self(void **state) {
    ...
    int ret = module_broadcast(NULL, (unsigned char *)"hi!", strlen("hi!"), 0);
    assert_false(ret == 0);
}
...
void test_module_broadcast_NULL_msg(void **state) {
    ...
    int ret = module_broadcast(self, NULL, strlen("hi!"), 0);
    assert_false(ret == 0);
}
...
void test_module_broadcast_wrong_size(void **state) {
    ...
    int ret = module_broadcast(self, (unsigned char *)"hi!", -1, 0);
    assert_false(ret == 0);
}
...
void test_module_broadcast(void **state) {
    ...
    int ret = module_broadcast(self, (unsigned char *)"hi3!", strlen("hi!"), 0);
    assert_true(ret == 0);
}
